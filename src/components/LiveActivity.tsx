...
const LiveActivity = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-gradient-to-r from-green-600 to-green-700 text-white py-1.5 px-4 shadow-lg animate-fade-in">
      <div className="max-w-2xl mx-auto flex items-center justify-center gap-2 text-xs flex-wrap">
